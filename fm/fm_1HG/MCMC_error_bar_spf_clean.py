...
""" author: J MAZOYER
A code that take the chain return of the MCMCs and plot the SPFs
"""
import os
import csv
import numpy as np
...
def measure_spf_errors(yaml_file_str, Number_rand_mcmc, Norm_90_inplot=1., save = True):
    """
    take a set of scatt angles and a set of HG parameter and return
    the log of a 2g HG SPF (usefull to fit from a set of points)
...
basedir = '/Users/jmazoyer/Dropbox/Work/python/python_data/KlipFM_for_SPF/hr_4796/resultats_mcmc_2001010/Aurora/'
...
index = (np.arange((error_GPIPolK1_extractPauline.shape[0]) / 2,dtype = int)) * 2 + 1
...
plot.errorbar(angles_GPIPolK1_extractPauline,
              ...
              fmt='x',
              label='GPI Pol K1 (extraction Arriaga et al. 2020)',
              ms=3,
              capthick=1,
              capsize=2,
              elinewidth=1,
