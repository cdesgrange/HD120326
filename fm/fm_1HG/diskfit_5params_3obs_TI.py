...
########################################################
def from_param_to_theta_init_7params(parameters_yaml):
    ...
    theta_init = (rad_init, pa_init, inc_init, g1_init, scaling1, scaling2, scaling3)
...
if __name__ == '__main__':
    ...
    THETA_INIT = from_param_to_theta_init_7params(params_yaml) # !!!
    ...
    if exploration_algo == "MCMC":
        ...
        bounds = [(10,100), (0,180), (70, 89), (0,1), (0,None), (0,None), (0,None)] #params_yaml['bounds'] #!!!
