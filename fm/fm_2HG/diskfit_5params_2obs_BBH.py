...
def chisquare_params(theta):
    if NOBS==1:
        ...
        Chisquare = chisquare_params_3obs_polar(theta)
    return Chisquare
...
def chisquare_params_2obs_polar(theta):
    ...
    theta1 = np.array([theta[0],theta[1],theta[2],theta[3],theta[5],True])
...
########################################################
def from_param_to_theta_init_6params(parameters_yaml):
    ...
    theta_init = (rad_init, pa_init, inc_init, g1_init, scaling1, scaling2)
...
if __name__ == '__main__':
    ...
    THETA_INIT = from_param_to_theta_init_6params(params_yaml) # !!!
    ...
    if exploration_algo == "MCMC":
        ...
        bounds = [(10,100), (0,180), (70, 89), (0,1), (0,None), (0,None)] #params_yaml['bounds'] #!!!
