...
sys.stdout = Logger("log_ifs_pca_infos_all_{}.txt".format(date))

#error
def log_error(message):
    with open("log_ifs_pca_errors_all_{}.txt".format(date), "a+") as myfile:
        myfile.write(f'ERROR : {message} \n')

print('\n===== Run detection limits IFS script =====\n')
...
try:
    ...
    for k in range(len(flist)) :
        ...
        except : im_limdet_ann_sec_slippy = compute_limdet_map_ann_sec_slippy(res_map, nb_pixel_section, dr, center=center, even_or_odd='even')
